    ...
    <AdminSidebar>
      <div className="relative">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-20 right-1/4 w-80 h-80 bg-blue-500/10 rounded-full blur-[100px] animate-pulse" />
          <div className="absolute bottom-1/3 left-1/3 w-72 h-72 bg-indigo-500/10 rounded-full blur-[90px] animate-pulse" />
        </div>
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          >
            ...
            >
              ...
              <span className="relative font-semibold text-white">Add Dua</span>
            </Link>
          </motion.div>
        </div>
        ...
        >
          ...
          {isLoading ? (
            <div className="relative p-16 text-center">
              <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center animate-pulse shadow-lg shadow-blue-500/30">
                <svg
              ...
              <p className="mt-4 text-slate-400 font-medium">Loading duas...</p>
            </div>
          ) : duas.length === 0 ? (
            <div className="relative p-16 text-center">
              ...
              <p className="text-slate-400 mb-4 text-lg">No duas found</p>
              <Link
                href="/admin/duas/new"
                      ...
                      >
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 border border-blue-500/20 flex items-center justify-center group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-500/20 transition-all duration-300">
                              <span className="text-2xl">🤲</span>
                            </div>
                            <div>
                        ...
                        <td className="px-6 py-5 hidden sm:table-cell">
                          <span className="inline-flex px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-sm text-slate-300">
                            {dua.reference || "—"}
                          </span>
                        </td>
